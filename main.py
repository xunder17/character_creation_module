...
def attack(char_name: str, char_class: str) -> str:
    """Perform the attack and return the string."""
...
def defence(char_name: str, char_class: str) -> str:
    """Block the damage and return the string."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Use a special skill and return the string."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Practice and return the string."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choose a character and return the string."""
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    """The main function that runs the game code."""
